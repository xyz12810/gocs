...
const (
	...
	IPv6AllNodesMulticastAddress Address = "\xff\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01"
	...
	IPv6Any Address = "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
)
...
func (b IPv6) TransportProtocol() TransportProtocolNumber {
	return TransportProtocolNumber(b.NextHeader())
}
...
func IsV4MappedAddress(addr Address) bool {
...
func IsV6MulticastAddress(addr Address) bool {
	if len(addr) != IPv6AddressSize {
		return false
	}
	return addr[0] == 0xff
...
func IsV6UnicastAddress(addr Address) bool {
	if len(addr) != IPv6AddressSize {
		return false
	}
...
// address.
func SolicitedNodeAddr(addr Address) Address {
