...
const (
	...
	ICMPv6ProtocolNumber TransportProtocolNumber = 58
...
// NDPPayload returns the NDP payload  That is, it returns the ICMPv6
...
func ICMPv6Checksum(h ICMPv6, src, dst Address, vv VectorisedView) uint16 {
