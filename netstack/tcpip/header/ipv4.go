...
const (
	...
	IPv4Broadcast Address = "\xff\xff\xff\xff"

	// IPv4Any is the non-routable IPv4 "any" meta address.
	IPv4Any Address = "\x00\x00\x00\x00"
...
func (b IPv4) SourceAddress() Address {
	return Address(b[srcAddr : srcAddr+IPv4AddressSize])
}

// DestinationAddress returns the "destination address" field of the ipv4
// header.
func (b IPv4) DestinationAddress() Address {
	return Address(b[dstAddr : dstAddr+IPv4AddressSize])
}
...
// will be 1110 = 0xe0.
func IsV4MulticastAddress(addr Address) bool {
